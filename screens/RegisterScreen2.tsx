...
const Step1 = ({birthday,sexcode}:any) =>
{
  
  return (
          <View style = {{flexDirection : "row"}}>
          <TextInput
            style={{...styles.inputbirth, color: "grey"}} value={birthday}
            placeholder = "생년월일 6자리" maxLength={6}/>
          <View style = {{alignItems : "center",justifyContent : "center"}}><Text> - </Text></View>
            <TextInput
            style={{...styles.inputbirth, width : 30, marginHorizontal : 0, color : "grey"}}
